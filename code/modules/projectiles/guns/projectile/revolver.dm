/obj/item/weapon/gun/projectile/diamondback
	name = "revolver"
	desc = "A Mustang-Arms Diamondback revolver. Uses .357 ammo."
	icon_state = "diamondback"
	item_state = "diamondback"
	caliber = "38"
...
/obj/item/weapon/gun/projectile/diamondback/verb/spin_cylinder()
...
/obj/item/weapon/gun/projectile/diamondback/consume_next_projectile()
	if(chamber_offset)
		chamber_offset--
		return
	return ..()
